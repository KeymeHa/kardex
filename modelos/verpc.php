         ...
         <div class="box <?php echo ( $equipo['estado'] == 1 )? 'box-success' : 'box-danger' ; ?>">
          <div class="box-body  box-<?php echo ($equipo['estado'] == 1 )? 'success' : 'danger' ; ?> ">
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <div class="item">
              <img src="vistas/img/equipos/edu-083/foto_1.jpg" alt="First slide" width="400">
              <div class="carousel-caption">
              Foto 1
              </div>
              </div>
              <div class="item">
              <img src="vistas/img/equipos/edu-083/foto_2.jpg" alt="Second slide" width="400">
              <div class="carousel-caption">
              Foto 2
              </div>
              </div>
              <div class="item active">
              <img src="vistas/img/equipos/edu-083/foto_3.jpg" alt="Third slide" width="400">
              <div class="carousel-caption">
              Foto 3
              </div>
              </div>
          ...
          <div class="box-footer">
            <?php echo ($equipo["estado"] != 0)?'<button class="btn btn-warning pull-right btn-editarFoto" data-toggle="modal" data-target="#modalEditarFotoPc" idPC="'.$equipo["id"].'" ><i class="fa fa-pencil"></i> Editar Imagenes</button>': '';?>
          </div>
        </div>
      </div>
                    ...
                    echo '
                      ...
                      case 4:
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-body">
                                <strong>'.$usr_gen.'</strong>: se Modifico .
                            </div>';
