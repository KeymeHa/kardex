         ...
         <div class="box box-success">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
                <div class="col-lg-2 col-md-6 col-xs-12">
                   <div class="form-group">
                    ...
                    <?php
                      echo ' <input type="text" class="form-control" id="codigoInterno" name="codigoInterno" required value="'.ControladorParametros::ctrradicacion().'" readonly>';
                  ...
                  { 
                   ...
                   <div class="form-group">
                    <label for="exampleInputEmail1">'.$tablasRad[$i][1].'</label>
                      <select class="form-control form_'.$tablasRad[$i][0].'" name="id_'.$tablasRad[$i][0].'" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2 col-md-4 col-xs-4"><button type="button" id="btnRemitente" class="btn btn-block btn-success btn-xs" data-toggle="modal" data-target="#modalRemitentes"><i class="fa fa-plus"></i></button></div>
          ...
          <div class="box-footer">
            ...
            <div class="col-lg-2 col-md-2 col-xs-2">
              ...
              <div class="col-lg-1 col-lg-1 col-xs-1"></div>
