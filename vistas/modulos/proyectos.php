      ...
      <div class="col-lg-12">
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            ...
            <button class="btn btn-success" data-toggle="modal" data-target="#modalAgregarProyecto"><i class="fa fa-plus"></i>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-calendar-check-o"></i></span> 
                 ...
                 <input type="date" class="form-control" name="fechaInicio" placeholder="dd/mm/AAAA" autocomplete="off" required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="hidden" class="form-control input-lg" id="editarID" name="editarIDProyecto" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-calendar-check-o"></i></span> 
                 ...
                 <input type="date" class="form-control" name="editarFechaInicio" placeholder="dd/mm/AAAA" autocomplete="off" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
               ...
               <input type="date" class="form-control" name="editarFechaFin" placeholder="dd/mm/AAAA" autocomplete="off" required>
