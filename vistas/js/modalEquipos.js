...
export function validarSerial(n_serie)
{
...
export function editarPC(idPC, nombre)
{
	$(".alert").remove();
	var  = new FormData();
...
export function agregarParametro(elemento, param){

	$(elemento).parent().parent().parent().children('div.div-add').children().remove();
	$(elemento).parent().parent().parent().children('div.div-add').append('<div class="col-lg-12 col-md-12 col-sm-12">'+
...
export function validarParametro(elemento, tipo, valor){
...
export function validarParametro2(elemento, valor, tipo){
	//buscar si existe
...
export function devolverEquipo(elemento, est){
