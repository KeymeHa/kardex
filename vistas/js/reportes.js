...
function validarRuta()
{
  if(localStorage.getItem("rutaURL") != null)
  {
    ...
    if (localStorage.getItem("rutaURL") != 'reportes') 
    {
      localStorage.removeItem("capturarRango");
      localStorage.setItem("rutaURL", 'reportes');
      $("#btn-RangoReportes span").html('<i class="fa fa-calendar"></i> Rango de fecha');
    }
...
{
  $("#btn-RangoReportes span").html(localStorage.getItem("capturarRango"));
}
else{
  $("#btn-RangoReportes span").html('<i class="fa fa-calendar"></i> Rango de fecha');
}
...
$('#btn-RangoReportes').daterangepicker(
  {
    ranges   : {
      'Hoy'       : [moment(), moment()],
  ...
  function (start, end) {
    $('#btn-RangoReportes span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

    var fechaInicial = start.format('YYYY-MM-DD');
    var fechaFinal = end.format('YYYY-MM-DD');

    var capturarRango = $("#btn-RangoReportes span").html();
