...
{	
	public $modp;
	public function mostrarTablapermisos()
	{	  
		$sw = 0;
...
$verPermisos = new TablaPermisos();

if( isset($_GET["modp"]))#modulo permiso
{
	$verPermisos -> modp = $_GET["modp"];
	$verPermisos -> mostrarTablapermisos();
}